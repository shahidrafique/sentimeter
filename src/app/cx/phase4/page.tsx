    ...
    <article className="phase4">
              ...
              <div className="analyze-features">
                <div className="feature blue">
                  ...
                  <div className="content">
                    ...
                    <p>Identify feedback with the greatest influence on satisfaction and loyalty.</p>
                  </div>
                </div>
                <div className="feature">
                  ...
                  />
                  <div className="content">
                    <h5 className="blue-80">Transactional Analytics (RFM Analysis):</h5>
                    <p>Understand customer behaviors and recovery needs for smarter prioritization.</p>
                  </div>
                </div>
                <div className="feature">
                  <Image
                  ...
                  <div className="content">
                    ...
                    <p>Address feedback from your most impactful customers first.</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="section has-bg automate-workflows">
        <div className="container">
          ...
          <div className="col content-group has-inner-text-blue">
            <h2>
              Automate Workflows for Seamless Action
            </h2>
            <p>
              Ensure no feedback is left unaddressed with Sentimeter’s automated workflows. Streamline processes to track, assign, and resolve every concern efficiently.
            </p>
            <ul className="checklist blue">
              <li className="checklist-item">
                <span>Real-Time Alerts:</span> Instantly flag and prioritize critical feedback.
              </li>
              <li className="checklist-item">
                <span>Auto-Assign Cases:</span> Route issues to the right teams for faster resolutions.
              </li>
              <li className="checklist-item">
                <span>Resolution Tracking:</span> Monitor issue progress from start to finish, ensuring accountability.
              </li>
            </ul>
            <p>
              <span>Why It Matters:</span> "Monitor issue progress from start to finish, ensuring accountability.”
            </p>
            <div className="row">
              <a href="#" className="link">
        ...
        <div className="card">
          <div className="container">
            ...
            <div className="col content">
              ...
              <p>
                Break down silos with Sentimeter’s unified dashboards. Empower CX, marketing, and operations teams to collaborate effectively and align on customer priorities.
              </p>
              <h5>Key Features:</h5>
              <div className="row">
                <div className="col">
                  ...
                  <p>
                    Segment data by sentiment, geography, customer type, or engagement metrics.
                  </p>
                </div>
                <div className="col">
                  <div className="icon">
                ...
                <div className="col">
                  ...
                  <p>
                    Deliver tailored data to ensure every team gets what they need.
                  </p>
                </div>
              </div>
              <p>
                <span>Why It Matters:</span> "When teams collaborate, customer experience improves—and everyone wins."
              </p>
              <div className="row">
        ...
        <div className="card">
          <div className="container">
            <div className="content-group has-inner-text-blue">
              ...
              <p>
                Show customers that their voices are heard. Sentimeter’s recovery management tools ensure you close the loop by addressing concerns and sharing how their feedback drives improvements.
              </p>
              <div className="card-blocks">
                ...
                <div className="card-blocks-item yellow">
                  ...
                  <p>
                    Automate follow-ups to confirm resolution.
                  </p>
                </div>
              ...
              <p>
                <span>Why It Matters:</span> “Closing the loop builds trust, strengthens relationships, and turns customers into advocates.“
              </p>
              <div className="row">
                <a href="#" className="link">
      ...
      <section className="section has-bg continuous-improvement">
        <div className="container">
          <div className="col content-group has-inner-text-blue">
            ...
            <p>
              Sentimeter’s real-time dashboards and automated reporting keep your team on top of progress, enabling constant refinement of strategies.
            </p>
            <ul className="checklist blue">
              <li className="checklist-item">
                <span>Live Dashboards:</span> Monitor metrics like NPS and CSAT in real time.
              </li>
              <li className="checklist-item">
                <span>Automated Reporting:</span> Generate periodic huddle-ready reports or export CSVs for detailed analysis.
              </li>
              <li className="checklist-item">
                <span>Ongoing Analysis:</span> Use dynamic filtering and insights to uncover new opportunities for improvement.
              </li>
            </ul>
            <p>
              <span>Why It Matters:</span> “Continuous improvement ensures you’re always delivering what your customers need.”
            </p>
            <div className="row">
              <a href="#" className="link">
              ...
              <Link href="#" className="button">Schedule a Demo</Link>
            </div>
          </div>
          <div className="col">
            <Image
        ...
        <div className="card">
          <div className="container">
            <div className="content-group has-inner-text-blue analyze-and-refine-left">
              ...
              <p>
                Sentimeter transforms insights into actions by automating processes, prioritizing feedback, and aligning teams to deliver exceptional customer experiences.
              </p>
              <div className="row">
                <Link href="#" className="link">
            ...
            <div className="analyze-and-refine-right">
              ...
              <ul className="checklist blue">
                <li className="checklist-item">
                  <span>Proactive Feedback Resolution:</span> Prevent issues with real-time alerts and automated workflows.
                </li>
                <li className="checklist-item">
                  <span>Collaborative Dashboards:</span> Unite teams with shared insights and action plans.
                </li>
                <li className="checklist-item">
                  <span>Recovery Management Module:</span> Built-in tools to address grievances quickly and effectively.
                </li>
                <li className="checklist-item">
                  <span>Actionable Data:</span> Use advanced analytics like RFM and dynamic filtering to focus efforts where they matter most.
                </li>
                <li className="checklist-item">
                  <span>Continuous Improvement:</span> Leverage live dashboards and automated reporting to refine strategies in real time.
                </li>
              </ul>
            </div>
          </div>
