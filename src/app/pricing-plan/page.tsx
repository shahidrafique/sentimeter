        ...
        <div className="card">
          <div className="container">
            <div className="col">
              ...
              <div>
                <h5 className="text-blue">We Get It: You Want Clarity, Not Forms</h5>
                <p>Sentimeter's pricing structure intelligently balances enterprise Voice of Customer needs with cutting-edge technology.</p>
              </div>
              <div>
                ...
                <ul className="checklist blue">
                  ...
                  <li className="checklist-item">
                    Cross-channel integration complexity (surveys, calls, chat, social)
                  </li>
                  <li className="checklist-item">
                  ...
                  <li className="checklist-item">
                    Enterprise system integration needs (CRM, ticketing, marketing)
                  </li>
                </ul>
              </div>
              <h5 className="text-black">Ready to transform customer feedback into strategic business advantage? Get your personalized quote today.</h5>
            </div>
            <div className="col">
              <div className="request-pricing-card">
                ...
                <form>
                  ...
                  <a href="#" className="button">Send Contact Request</a>
                </form>
              </div>
            </div>
          </div>
